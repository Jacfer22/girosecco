...
export default function MappaNavigatore({
  ...
  useEffect(() => {
    ...
    const chiaveIcona = markerPosizioneHtml ?? `${mascotId}-${Math.round(rot / 6)}`;
  ...
  }, [posizione, segui, markerPosizioneHtml, mascotId, percorsoGps, percorsoNav, destinazione, zoomMinimo, seguiAnimato]);
